  ...
  return (
    ...
    >
      ...
      <Typography>
        ...
        পক্ষই সক্রিয় হয়ে উঠতে শুরু করে।[টীকা ১][২] এপ্রিলের দ্বিতীয় সপ্তাহেই
        পাকিস্তানি বাহিনীকে আটকানোর জন্য মুশুল্লী উচ্চ বিদ্যালয়ে গোপনে মেজর
        খালেদ মোশাররফ ও এটিএম হায়দারের নেতৃত্বে স্থানীয় মুক্তিযোদ্ধা ও
        সংগঠকদের একটি বৈঠক অনুষ্ঠিত হয়।[২] বৈঠকের কয়েকদিনের মধ্যে পরিকল্পনা
        মোতাবেক ডিনামাইট দিয়ে মুশুল্লী রেলওয়ে স্টেশনের দক্ষিণে অবস্থিত শুভখিলা
        রেলব্রিজ ধ্বসিয়ে দেওয়া হয়। মেজর খালেদ এ অপারেশনে নেতৃত্ব দেন।[২] ফলে
        কিশোরগঞ্জ থেকে রেলপথে ভারী অস্ত্রসহ পাকিস্তানি সেনাবাহিনীর আসার পথ
        আপাতদৃষ্টিতে বন্ধ হয়ে যায়। কিন্তু কয়েকদিন পরেই কিশোরগঞ্জ থেকে
        পাকিস্তানি বাহিনী শুভখিলা রেলব্রিজ পর্যন্ত আসে এবং স্থানীয়দের নদী
        পারাপারের নৌকায় হালকা অস্ত্রসহ নান্দাইলে প্রবেশ করে।[২] অন্যদিকে
        সড়কপথে সশস্ত্র পাকিস্তানি বাহিনীর আগমন ঠেকানোর জন্য ১৮ এপ্রিল নান্দাইল
        শহরের প্রবেশমুখে কিশোরগঞ্জ সড়কের অংশবিশেষ কেটে ট্রেঞ্চ তৈরি করা হয়।
        কিন্তু স্থানীয় দালালদের সহায়তায় আগেই খবর পেয়ে পাকবাহিনী সতর্ক হয়ে
        যায় এবং এ ঘটনায় স্থানীয় আওয়ামী লীগ সভাপতি শাহনেওয়াজ ভূঁইয়াসহ সাত
        জনের বিরুদ্ধে নান্দাইল থানায় মামলা করা হয়। ২১ এপ্রিল মেজর আশফাকের
        নেতৃত্বে পাকবাহিনী নান্দাইলে ঘাঁটি স্থাপন করে।[২] এই দিন রাজগাঁতী,
        শুভখিলা ও কালীগঞ্জ এলাকায় ১৮ জন গ্রামবাসীকে হত্যা করা হয় ও কয়েকশ
        বাড়িঘর পুড়িয়ে দেয়া হয়। পাকিস্তান সেনাবাহিনী নান্দাইল শহরের তিন-চার
        কিলোমিটার পূর্বে বারুইগ্রাম মাদ্রাসায় ক্যাম্প স্থাপন করে। স্থানীয়
        সংখ্যালঘু সম্প্রদায় নান্দাইল শহরের পার্শ্ববর্তী আমুদাবাদ গ্রামে আশ্রয়
        নেয় এবং স্থানীয় দালালদের সাথে গোপন সমঝোতার মাধ্যমে নিয়ন্ত্রিত
        জীবনযাপন করতে বাধ্য হয়।[২]
      </Typography>{" "}
      <h4
        style={{
          color: "#CC2D3C",
      ...
      <Typography>
        ...
        "নান্দাইল মুক্ত দিবস" হিসেবে বিবেচনা করা হয়।[৫]
      </Typography>{" "}
      <h4
        style={{
          color: "#CC2D3C",
      ...
      <Typography>
        ...
        সালের ১৫ ডিসেম্বর নান্দাইল উপজেলা সৃষ্টি হয়।[৬]
      </Typography>{" "}
      <h4
        style={{
          color: "#CC2D3C",
      ...
      <Typography>
        ...
        উপজেলার প্রশাসনিক কার্যক্রম নান্দাইল থানার আওতাধীন।[৯]
      </Typography>{" "}
      <h4
        style={{
          color: "#CC2D3C",
      ...
      <Typography>
        ...
        শিক্ষার হার ৪০.৩৮%।[১১] বাৎসরিক জনসংখ্যা বৃদ্ধির হার ১.২১%। ১৯৯১ সালের
        ...
        জাতীয় শিক্ষার হার ছিল ৩২.৪%।[১২]
      </Typography>
    </Box>
  );
}
